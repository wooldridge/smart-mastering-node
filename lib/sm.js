const marklogic      = require('marklogic')
      ...
      MatchBuilder   = require('./match-builder'),
      MatchMerge     = require('./match-merge'),
      MatchOptions   = require('./match-options'),
      MergeBuilder   = require('./merge-builder'),
 ...
 * @param {string} [inputParams.user=""] User with permission to execute mastering tasks.
 * Not required for match options builder and merge options builder methods.
...
function SmartMasteringClient(inputParams) {
  ...
  } else if (connectionParams.user == null) {
    connectionParams.user = '';
  }  else if (connectionParams.password == null) {
  ...
  this.matchBuilder   = MatchBuilder(this);
...
module.exports = {
    ...
    /**
     * A factory for creating a match options builder
     * @function mastering.createMatchOptions
     * @returns {matchBuilder} Helper for defining match options
     */
    createMatchOptions:  MatchBuilder,
    /**
     * A factory for creating a merge options builder
     * @function mastering.createMergeOptions
     * @returns {mergeBuilder} Helper for defining merge options
     */
    createMergeOptions:  MergeBuilder
};
