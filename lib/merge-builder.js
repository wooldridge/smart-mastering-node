...
/**
 * Sets the match options for the merge.
 * @method mergeBuilder#matchOptions
 * @param {string} name Name of the match options
 * @returns {mergeBuilder.BuiltOptions} Built merge options
 */
MergeBuilder.prototype.matchOptions = function matchOptionsMerge(name) {
  if (!name) {
    throw new Error('A name is required.');
  }
  this.options.matchOptions = name;
  return this;
}

/**
 * Sets the path to a timestamp value for sorting.
 * @method mergeBuilder#timestamp
 ...
 * @method mergeBuilder#sourceWeight
